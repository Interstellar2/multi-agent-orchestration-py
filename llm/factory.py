...
from llm.model_type import ModelType
from llm.providers import openai, bailian, deepseek, kimi, openrouter
...
class LLMFactory:
    ...
    def get_model(self, model_type: str | ModelType) -> BaseChatModel:
    ...
    def register_model(self, model_type: str | ModelType, model: BaseChatModel) -> None:
        """动态注册新模型"""
        if isinstance(model_type, str):
            try:
                model_type = ModelType(model_type)
